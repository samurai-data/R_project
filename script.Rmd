...
*Preparation des données et library*
```{r,warning=FALSE}
...
## La population de l'etude entre la sexe et l'âge
```{r}
...
En conséquence, si l'on considère le rapport hommes/femmes par groupe d'âge, on constate que, tant pour la première que pour la sixième vague, la proportion de femmes est supérieure à celle des hommes de moins de 49 ans. En particulier, une grande différence peut être observée lors de la première vague, où 39.4% des hommes et 60.6% des femmes sont âgés de moins de 29 ans, et lors de la sixième vague, où 39.5% des hommes et 60.5% des femmes sont âgés de 30 à 39 ans.3 Les analyses futures devraient tenir compte du rapport entre les hommes et les femmes de moins de 49 ans.
...
```{r}
#fusionner les deux vagues
s_nerveux <- cbind(nervex6, nerveux6)
#presenter le tableau
...
# l’impact sur la bien-être et la santé mentale 
...
### Tableau de comparaison : Etat de santé
```{r}
#fusionner les deux vagues
...
### Tableau de comparaison : acvitivité sportive
```{r}
#fusionner les deux vagues
...
### Tableau de comparaison : Fréquence de temps à dormir 
...
```
### Tableau de comparaison : Fréquence des rencontres avec des amis dans la vie réelle
```{r}
#fusionner les deux vagues
...
```
### Tableau de comparaison : Fréquence des rencontres avec la famille dans la vie réelle
```{r}
#fusionner les deux vagues
...
### Tableau de comparaison : Avis sur l'expérience du confinement
```{r}
#fusionner les deux vagues
